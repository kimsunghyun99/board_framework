...
window.onload = () => {
	...
	btnRegister.addEventListener('click',async()=> {
		...
		if(Pass != Pass1) {
			...
			// 암호 규칙 --> 8~20자리 내에 영문, 숫자 , 특수문자를 조합
...
<div class="WriteForm">
	...
	<label><input type="radio" name="gender" value="여성">여성</label><br><br>
	취미 :
	...
	<input type="button" id="btn_addSearch" class="btn_addSearch" value="주소검색" onclick="searchAddr()">
	<input type="text" id="zipcode" name="zipcode" class="input_field" placeholder="우편변호가 검색되어 입력됩니다." readonly>
	<input type="text" id="addr1" name="addr1" class="input_field" placeholder="주소가 검색되어 입력됩니다." readonly>
	<input type="text" id="addr2" name="addr2" class="input_field" placeholder="상세 주소를 입력하세요." >
